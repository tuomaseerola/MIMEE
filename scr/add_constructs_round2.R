add_constructs_round2 <- function(
  data = NULL,
  construct = NULL,
  verbose = FALSE
) {
  ...
  if (construct == 'FC2') {
    ...
    data$construct[str_detect(
      data$name,
      'AIA_Rele_1$|AIA_Rele_2$|AIA_Rele_3$|AIA_Rele_4$|AIA_Rele_5$|AIA_Rele_6$|AIA_Rele_7$|AIA_Rele_8$|AIA_Rele_9$|AIA_Rele_10$|AIA_Rele_11$|AIA_Rele_12$'
    )] <- 'Moved'
    data$construct[str_detect(
      data$name,
      'AIA_Rele_13$|AIA_Rele_14$|AIA_Rele_15$|AIA_Rele_16$|AIA_Rele_17$|AIA_Rele_18$|AIA_Rele_19$|AIA_Rele_20$|AIA_Rele_21$|AIA_Rele_22$|AIA_Rele_23$|AIA_Rele_24$|AIA_Rele_25$'
    )] <- 'Curiosity'
    data$construct[str_detect(
      data$name,
      'AIA_Rele_26$|AIA_Rele_27$|AIA_Rele_28$|AIA_Rele_29$|AIA_Rele_30$|AIA_Rele_31$|AIA_Rele_32$|AIA_Rele_33$|AIA_Rele_34$|AIA_Rele_35$'
    )] <- 'Aesthetics'
    data$construct[str_detect(
      data$name,
      'PEP_Rele_1$|PEP_Rele_2$|PEP_Rele_3$|PEP_Rele_4$|PEP_Rele_5$|PEP_Rele_6$|PEP_Rele_7$|PEP_Rele_8$|PEP_Rele_9$|PEP_Rele_10$|PEP_Rele_11$|PEP_Rele_12$'
    )] <- 'Coping'
    data$construct[str_detect(
      data$name,
      'PEP_Rele_13$|PEP_Rele_14$|PEP_Rele_15$|PEP_Rele_16$|PEP_Rele_17$|PEP_Rele_18$|PEP_Rele_19$|PEP_Rele_20$|PEP_Rele_21$|PEP_Rele_22$|PEP_Rele_23$|PEP_Rele_24$|PEP_Rele_25$|PEP_Rele_26$|PEP_Rele_27$'
    )] <- 'Feeling'
    data$construct[str_detect(
      data$name,
    ...
    data$construct[str_detect(
      data$name,
      'EDR_Rele_27$|EDR_Rele_28$|EDR_Rele_29$|EDR_Rele_30$|EDR_Rele_31$|EDR_Rele_32$|EDR_Rele_33$|EDR_Rele_34$|EDR_Rele_35$|EDR_Rele_36$'
    )] <- 'Distraction'
  }
