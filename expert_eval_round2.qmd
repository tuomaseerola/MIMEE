...
cowplot::plot_grid(fig[[which(index)[1]]],fig[[which(index)[2]]],fig[[which(index)[3]]],fig[[which(index)[4]]],fig[[which(index)[5]]],fig[[which(index)[6]]],ncol=1,nrow=6)
...
knitr::kable(Items[[which(index)[6]]],digits=2,caption = Categories$LMA[6])
```
